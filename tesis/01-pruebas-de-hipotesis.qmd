...
no dice absolutamente nada. Este proceso se describe con mayor detenimiento más
adelante.
...
Para ahondar aún más en su interpretación, considera la siguiente dispersión
de Moran para la cual se determinó el estadístico $I$:

![Ejemplo de dispersión de Moran](./figuras/01/moran.png){width=300}
...
desviaciones estándar de la media de los datos, entonces puedes inferir lo
siguiente:
