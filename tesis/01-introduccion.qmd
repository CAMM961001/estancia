...
datos en general, son aplicables a este tipo de datos. En ese sentido, algunas
metodologías de ciencia de datos, por ejemplo CRISP-DM, son aplicables a un
contexto geoespacial.

Como dicha metodología plantea, para un proceso de ciencia de datos geoespacial
también se pueden generalizar los pasos en:
...
Los datos se crean y recolectan principalmente en dos tipos:
