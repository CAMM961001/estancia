...
para asistir el análsis de oferta y demanda de los socios conductores del
...
elementos de menor jerarquía (también conocidos como **hijos**). Lo anterior es
conocido como **apertura 7** y se ilustra a continuación:

![Un elemento contiene aproximadamente 7 de menor jerarquía](./figuras/02/ejemplo_h3.png){height=250}

Sin embargo, si bien un elemento no se subdivide limpiamente en siete hexágonos
más finos, al rotar los elementos entre sí se consigue una aproximación
decente conocida como **contención aproximada**, de modo que el área de cada
hijo es de aproximadamente 1/7 del área de su respectivo padre. En total se
tienen 16 niveles de jerarquía en este sistema, estando el primero comprendido
por 122 hexágonos, mientras que el de máxima resolución cuenta con más de
$569x10^{12}$ elementos únicos.
